...
hook_cfg_list = [
    ...
    dict(type='WarmupHook', warmup_steps=40*6, period=5, lr=lr), 
    dict(type='IterBasedSaveTopkHook', top_k=3, monitor='recall_average', save_after=20, iter_period=40, checkpoint_dir='checkpoints/')
]
