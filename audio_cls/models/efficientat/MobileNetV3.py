...
from audio_cls.models.efficientat.utils import cnn_out_size
from audio_cls.models.efficientat.block_types import InvertedResidualConfig, InvertedResidual
from audio_cls.models.efficientat.attention_pooling import MultiHeadAttentionPooling
...
def get_efficientat_model(num_classes: int = 527, pretrained_name: str = None, width_mult: float = 1.0,
