...
from audio_cls.models.htsat.layers import PatchEmbed, Mlp, DropPath, trunc_normal_, to_2tuple
from audio_cls.models.htsat.utils import do_mixup, interpolate
...
class HTSAT_Swin_Transformer(nn.Module):
    ...
    def __init__(self, spec_size=256, patch_size=4, patch_stride=(4,4), 
        ...
        self.logmel_extractor = LogmelFilterBank(sr=config.resample_rate, n_fft=config.window_size, 
...
class HtsatAudioModel(nn.Module):
    def __init__(
            self, spec_size, patch_size, in_chans, num_classes, window_size, 
